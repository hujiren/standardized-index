...
@Component
@Service
public class ModuleDistrictSchoolHandler implements ModuleHandler {
  ...
  public boolean support(String type) {
    return ModuleEnum.MODULE_DISTRICT_SCHOOL.name().equals(type);
  }
   ...
   * 计算学校环比等.
   */
  public void calSchoolRatio(StatementParam param, ModuleDistrictHotpotBaseValue value) {
