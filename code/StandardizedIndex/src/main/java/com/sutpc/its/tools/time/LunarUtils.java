...
public class LunarUtils {
  ...
  public final String animalsYear() {
    final String[] Animals = new String[]{"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗",
        "猪"};
    return Animals[(year - 4) % 12];
  }

  public String getLunarMonth(int month) {
  ...
  /*public static void main(String[] args) {
    ...
    try {
      //dateFormat.parse("20190523");
      //today.setTime(dateFormat.parse("2019-05-23"));
      today.setTimeInMillis(dateFormat.parse("2019-05-23").getTime());

    } catch (ParseException e) {
      e.printStackTrace();
    }
    com.sutpc.its.tools.time.LunarUtils lunar = new com.sutpc.its.tools.time.LunarUtils(today);
